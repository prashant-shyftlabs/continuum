...
from continuum.agent.smart_layer.completion import (
    build_model_tier_messages,
    complete_non_stream,
    temperature_for_tier,
)
from continuum.agent.smart_layer.resolve import (
...
if TYPE_CHECKING:
    from continuum.agent.utils.context_utils import RunContext
