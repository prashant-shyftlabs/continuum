...
class ErrorReporter:
    ...
    Example:
        ```python
        from orchestrator.observability.error_reporter import ErrorReporter
    ...
    def report(
        ...
        *,
        ...
        if immediate is None:
            from orchestrator.exceptions import ErrorSeverity, OrchestratorError
    ...
    def _build_error_data(
        ...
        from orchestrator.exceptions import OrchestratorError
        from orchestrator.logging import get_log_context
